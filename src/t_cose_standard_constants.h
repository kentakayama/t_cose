 ...
 *
 * RFC 8152 section 8.2 suggests, but does not require, that this
 * algorithm identifier only be used with keys based on the edwards25519
 * or edwards448 curves (also known as Ed25519 or Ed448 respectively).
 *
